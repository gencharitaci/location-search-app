// contexts/SelectedPointProvider.tsx
...
export const SelectedPointProvider: FC<SelectedPointProviderProps> = ({
  ...
  const tablesDefault: IQueryNearbyTable[] = [
    { table_name: "busstops_pt" },
    { table_name: "cats_light_rail_stations" },
    { table_name: "cats_park_and_ride" },
    { table_name: "charlotte_fire_department_stations" },
